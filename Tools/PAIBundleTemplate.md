...
purpose: Transform OpenCode into a production-grade personal AI infrastructure with memory, skills, voice, and identity
...
keywords: [personal-ai, infrastructure, plugins, history, skills, voice, identity, automation, opencode]
---
```
...
mkdir -p $PAI_DIR/{plugins,history,skills,tools}
...
# Restart OpenCode to activate all plugins
```
...
**The test:** Can someone go from fresh OpenCode to fully working bundle using ONLY this README?
