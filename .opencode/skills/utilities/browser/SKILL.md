...
`~/.config/opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/browser/`
...
**Headless by default.** All automation runs in headless mode. When the user says "show me" or wants to see what the assistant is seeing, open the URL in their preferred browser from `~/.config/opencode/skills/PAI/USER/TECHSTACKPREFERENCES.md`:
