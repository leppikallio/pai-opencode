...
- docx CLI available at `~/.config/opencode/skills/utilities/documents/docx/Tools/DocxCli.ts`
...
```bash
echo "${markdown_content}" | bun "~/.config/opencode/skills/utilities/documents/docx/Tools/DocxCli.ts" create - -o <output.docx> \
  --title "Document Title" \
  --author "Author Name"
```
...
bun "~/.config/opencode/skills/utilities/documents/docx/Tools/DocxCli.ts" create quarterly-report.md \
