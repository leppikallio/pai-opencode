...
PATTERN_PATH=~/.config/opencode/skills/utilities/fabric/Patterns/$PATTERN_NAME/system.md
...
if [ -f "$PATTERN_PATH" ]; then
  ...
  ls ~/.config/opencode/skills/utilities/fabric/Patterns/ | head -20
fi
```
...
**Pattern not found:**
```
Pattern '[name]' not found in ~/.config/opencode/skills/utilities/fabric/Patterns/
