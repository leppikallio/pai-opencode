...
**If using an MCP integration:** update the integration package/tooling used by your environment.
...
### OpenCode Skill Issues

If the **beads skill** provides incorrect guidance:

1. **Check skill version:**
   ```bash
   ls -la ~/.config/opencode/skills/utilities/beads/
   head -20 ~/.config/opencode/skills/utilities/beads/SKILL.md
   ```

2. **Report via OpenCode feedback** or the repository's issue tracker
