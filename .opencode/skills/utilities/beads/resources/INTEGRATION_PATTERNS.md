...
How the beads skill integrates with TodoWrite, writing-plans, and other skills for optimal workflow.
...
**Tools used**: beads + developing-strategic-documents skill
...
**Tools used**: beads + systematic-debugging (if issues found)
