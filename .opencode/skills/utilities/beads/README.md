# Beads Utility Skill for OpenCode

A utility skill for using [beads](https://github.com/steveyegge/beads) (bd) issue tracking in OpenCode.

## What This Skill Does

This skill documents how to use bd effectively for:
...
Copy the `beads/` directory into your OpenCode utility-skills tree:

```bash
# Global installation
cp -r beads ~/.config/opencode/skills/utilities/

# Or project-local
cp -r beads .opencode/skills/utilities/
```

## When OpenCode Uses This Skill
...
```
beads/
├── SKILL.md                 # Main skill file (OpenCode reads this first)
├── REFERENCE.md                # Maintenance guide for updating the skill
...
When context gets compacted, conversation history is lost but bd state survives. Write notes as if explaining to a future session with zero context:
...
This skill is imported from [github.com/steveyegge/beads](https://github.com/steveyegge/beads) and adapted for OpenCode utility-skill usage in this repository.
