...
|-----------|----------------|---------------|
| Response format | `~/.config/opencode/skills/PAI/SYSTEM/RESPONSEFORMAT.md` | `~/.config/opencode/skills/PAI/USER/RESPONSEFORMAT.md` |
| Security patterns | `~/.config/opencode/skills/PAI/SYSTEM/PAISECURITYSYSTEM/` | `~/.config/opencode/skills/PAI/USER/PAISECURITYSYSTEM/` |
| Skill behavior | Skill's `SKILL.md` | `~/.config/opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/[Skill]/` |
