...
```
~/.config/opencode/skills/PAI/Tools/Banner.ts
```
...
bun ~/.config/opencode/skills/PAI/Tools/Banner.ts

# Display specific design
bun ~/.config/opencode/skills/PAI/Tools/Banner.ts --design=electric

# Preview all designs
bun ~/.config/opencode/skills/PAI/Tools/Banner.ts --test
```
