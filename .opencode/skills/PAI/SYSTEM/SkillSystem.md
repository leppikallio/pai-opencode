...
- Reference `~/.config/opencode/skills/PAI/USER/` for any personalization
...
- `~/.config/opencode/skills/PAI/USER/CONTACTS.md` - Contact information
- `~/.config/opencode/skills/PAI/USER/TECHSTACKPREFERENCES.md` - Tech preferences
```
...
`~/.config/opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/{SkillName}/`
...
```
~/.config/opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/
...
1. **Create directory**: `mkdir -p ~/.config/opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/SkillName`
...
```bash
bun run ~/.config/opencode/skills/PAI/Tools/GenerateSkillIndex.ts
```
...
- The list is maintained in: `~/.config/opencode/skills/PAI/Tools/GenerateSkillIndex.ts` (`ALWAYS_LOADED_SKILLS`).
...
Read ~/.config/opencode/skills/PAI/Aesthetic.md
```
...
- ❌ Pure utility wrappers (use `~/.config/opencode/skills/PAI/SYSTEM/TOOLS.md` instead)
...
**See:** `~/.config/opencode/skills/PAI/SYSTEM/CLIFIRSTARCHITECTURE.md` (Workflow-to-Tool Integration section)
...
**See:** `~/.config/opencode/skills/PAI/SYSTEM/CLIFIRSTARCHITECTURE.md` (Configuration Flags section) for full documentation
