...
# With JSON output
bun ~/.config/opencode/skills/PAI/Tools/Inference.ts --json --level fast "Return JSON" "Input"

# Custom timeout
bun ~/.config/opencode/skills/PAI/Tools/Inference.ts --level standard --timeout 60000 "Prompt" "Input"
```
...
**Location:** `~/.config/opencode/skills/PAI/Tools/RemoveBg.ts`
...
bun ~/.config/opencode/skills/PAI/Tools/RemoveBg.ts /path/to/image.png

# Remove background and save to different path
bun ~/.config/opencode/skills/PAI/Tools/RemoveBg.ts /path/to/input.png /path/to/output.png

# Process multiple images
bun ~/.config/opencode/skills/PAI/Tools/RemoveBg.ts image1.png image2.png image3.png
```
...
**Location:** `~/.config/opencode/skills/PAI/Tools/AddBg.ts`
...
bun ~/.config/opencode/skills/PAI/Tools/AddBg.ts /path/to/transparent.png "#EAE9DF" /path/to/output.png

# Add UL brand background color
bun ~/.config/opencode/skills/PAI/Tools/AddBg.ts /path/to/transparent.png --ul-brand /path/to/output.png
```
...
**Location:** `~/.config/opencode/skills/PAI/Tools/GetTranscript.ts`
...
bun ~/.config/opencode/skills/PAI/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=VIDEO_ID"

# Save transcript to file
bun ~/.config/opencode/skills/PAI/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=VIDEO_ID" --save /path/to/transcript.txt
```
...
**Location:** `~/.config/opencode/skills/PAI/Tools/extract-transcript.py`
...
cd ~/.config/opencode/skills/PAI/Tools/
...
**Location:** `~/.config/opencode/skills/PAI/Tools/YouTubeApi.ts`
...
bun ~/.config/opencode/skills/PAI/Tools/YouTubeApi.ts --channel-stats

# Get video statistics
bun ~/.config/opencode/skills/PAI/Tools/YouTubeApi.ts --video-stats VIDEO_ID

# Get latest uploads
bun ~/.config/opencode/skills/PAI/Tools/YouTubeApi.ts --latest-videos
```
...
1. **Add tool file:** Place `.ts` or `.py` file directly in `~/.config/opencode/skills/PAI/Tools/`
...
2. **Document here:** Add section to this file with:
   - Tool location (e.g., `~/.config/opencode/skills/PAI/Tools/<ToolName>.ts`)
   - Usage examples
   - When to use triggers
   - Environment variables (if any)

3. **Update `~/.config/opencode/skills/PAI/SKILL.md`:** Ensure `~/.config/opencode/skills/PAI/SYSTEM/TOOLS.md` is in the documentation index
...
- **Images** → `~/.config/opencode/skills/PAI/Tools/RemoveBg.ts`, `~/.config/opencode/skills/PAI/Tools/AddBg.ts` (2024-12-22)
- **VideoTranscript** → `~/.config/opencode/skills/PAI/Tools/GetTranscript.ts` (2024-12-22)
- **VoiceNarration** → Voice server API (2024-12-22)
- **ExtractTranscript** → `~/.config/opencode/skills/PAI/Tools/extract-transcript.py`, `~/.config/opencode/skills/PAI/Tools/ExtractTranscript.ts` (2024-12-22)
- **YouTube** → `~/.config/opencode/skills/PAI/Tools/YouTubeApi.ts` (2024-12-22)
