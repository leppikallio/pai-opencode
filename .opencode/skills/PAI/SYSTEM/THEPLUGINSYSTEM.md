...
- `context-loader.ts` - Reads `~/.config/opencode/skills/PAI/SKILL.md` and injects PAI context
- Loads `~/.config/opencode/skills/PAI/SYSTEM/*.md` for system documentation
- Loads `~/.config/opencode/skills/PAI/USER/TELOS/*.md` for personal context
...
- `~/.config/opencode/skills/PAI/USER/DAIDENTITY.md` → AI personality and voice settings
- `~/.config/opencode/skills/PAI/USER/TELOS/` → User context, goals, and preferences
...
**Check:**
1. Does `~/.config/opencode/skills/PAI/SKILL.md` exist?
...
- **Architecture:** `~/.config/opencode/skills/PAI/SYSTEM/PAISYSTEMARCHITECTURE.md`
- **Security Patterns:** `~/.config/opencode/skills/PAI/SYSTEM/PAISECURITYSYSTEM/patterns.example.yaml`
