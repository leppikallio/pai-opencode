...
**Location:** `~/.config/opencode/skills/PAI/Tools/`

| Tool | Purpose |
|------|---------|
| `~/.config/opencode/skills/PAI/Tools/RemoveBg.ts` | Remove backgrounds using remove.bg API |
| `~/.config/opencode/skills/PAI/Tools/AddBg.ts` | Add solid background color to transparent images |
...
bun ~/.config/opencode/skills/PAI/Tools/RemoveBg.ts image.png

# Single file with output path
bun ~/.config/opencode/skills/PAI/Tools/RemoveBg.ts input.png output.png
...
bun ~/.config/opencode/skills/PAI/Tools/AddBg.ts input.png "#FFFFFF" output.png

# Add UL brand background (sepia/cream #EAE9DF)
bun ~/.config/opencode/skills/PAI/Tools/AddBg.ts input.png --ul-brand output.png
```
...
```bash
bun ~/.config/opencode/skills/PAI/Tools/RemoveBg.ts ~/Downloads/ai-generated-header.png
...
bun ~/.config/opencode/skills/PAI/Tools/RemoveBg.ts header.png header-transparent.png

# Then add UL brand background
bun ~/.config/opencode/skills/PAI/Tools/AddBg.ts header-transparent.png --ul-brand header-thumb.png
```

### Example 3: Batch Remove Backgrounds

```bash
bun ~/.config/opencode/skills/PAI/Tools/RemoveBg.ts diagram1.png diagram2.png diagram3.png
...
```bash
bun ~/.config/opencode/skills/PAI/Tools/AddBg.ts logo-transparent.png "#1a1a1a" logo-dark.png
```

### Example 5: Add White Background

```bash
bun ~/.config/opencode/skills/PAI/Tools/AddBg.ts chart.png "#FFFFFF" chart-white.png
```
