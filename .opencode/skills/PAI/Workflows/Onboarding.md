...
|-----------|------|---------|
| **TELOS** | `~/.config/opencode/skills/PAI/USER/TELOS/TELOS.md` | Your mission, goals, values, challenges |
| **Identity** | `~/.config/opencode/skills/PAI/USER/DAIDENTITY.md` | AI name, personality, voice preferences |
| **Contacts** | `~/.config/opencode/skills/PAI/USER/CONTACTS.md` | Important people in your life/work |
| **Stack** | `~/.config/opencode/skills/PAI/USER/TECHSTACKPREFERENCES.md` | Technology preferences |
| **Steering Rules** | `~/.config/opencode/skills/PAI/USER/AISTEERINGRULES.md` | Custom AI behavior rules |
...
1. Write all generated files to `~/.config/opencode/skills/PAI/USER/`
...
- **Portable:** Copy `~/.config/opencode/skills/PAI/USER/` to migrate to new installations
