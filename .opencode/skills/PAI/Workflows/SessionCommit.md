...
2. **Update progress file**
   ```bash
   bun run ~/.config/opencode/skills/PAI/Tools/SessionProgress.ts next <project> "<next step 1>" "<next step 2>"
   bun run ~/.config/opencode/skills/PAI/Tools/SessionProgress.ts handoff <project> "<handoff notes>"
   ```

3. **Update feature registry**
   ```bash
   bun run ~/.config/opencode/skills/PAI/Tools/FeatureRegistry.ts list <project>
...
This comes from:
```bash
bun run ~/.config/opencode/skills/PAI/Tools/FeatureRegistry.ts verify <project>
```
