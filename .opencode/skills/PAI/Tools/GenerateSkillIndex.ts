 ...
 *
 * Usage: bun run ~/.config/opencode/skills/PAI/Tools/GenerateSkillIndex.ts
 *
...
function usage(opts?: Partial<Options>) {
  ...
  console.log('');
  console.log('Usage:');
  console.log('  bun run ~/.config/opencode/skills/PAI/Tools/GenerateSkillIndex.ts [options]');
  console.log('');
  console.log('Options:');
