...
${DARK}──────────────────────────────────────────────────────────${RESET}
  ${GREEN}✓${RESET} ${DIM}PAI LOADED${RESET}    ${DARK}│${RESET} ${DIM}v2.0${RESET}    ${DARK}│${RESET} ${DIM}${new Date().toISOString().split('T')[0]}${RESET}
`;
}
...
${CYAN}│${RESET}   ${BOLD}${WHITE}╩ ╩${CYAN}╩ ╩${NEON_PINK}╩${RESET}
${CYAN}│${RESET}
${CYAN}│${RESET}   ${GREEN}●${RESET} ${DIM}PAI${RESET}    ${GREEN}●${RESET} ${DIM}SKILLS${RESET}    ${GREEN}●${RESET} ${DIM}HOOKS${RESET}
${CYAN}│${RESET}
${CYAN}└─────────────────────────────────────────────────────────────
`;
}
...
${DARK}────────────────────────────────────────────────────────────────${RESET}
${GREEN}  ✓${RESET} ${DIM}PAI LOADED${RESET}                          ${DARK}[${DIM}init: 0.${Math.floor(Math.random()*900)+100}s${DARK}]${RESET}
`;
}
