 ...
 *
 * Usage:
 *   import { loadSkillConfig } from '~/.config/opencode/skills/PAI/Tools/LoadSkillConfig';
 *   const config = loadSkillConfig<MyConfigType>(__dirname, 'config.json');
 *
 * Or CLI:
 *   bun ~/.config/opencode/skills/PAI/Tools/LoadSkillConfig.ts <skill-dir> <filename>
 */
