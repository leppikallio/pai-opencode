...
`~/.config/opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/youtube-channels.json`
...
test -f ~/.config/opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/youtube-channels.json \
  && cat ~/.config/opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/youtube-channels.json \
