...
`~/.config/opencode/skills/CORE/USER/SKILLCUSTOMIZATIONS/first-principles/`
...
- `message`: "Running the WORKFLOWNAME workflow from the first-principles skill"
Running the **WorkflowName** workflow from the **first-principles** skill...
```
...
→ RedTeam uses first-principles/Challenge to attack assumptions
