...
`~/.config/opencode/skills/CORE/USER/SKILLCUSTOMIZATIONS/create-cli/`
...
- `message`: "Running the WORKFLOWNAME workflow from the create-cli skill"
Running the **WorkflowName** workflow from the **create-cli** skill...
```
...
Do not assume a `Tools/` directory exists for create-cli.
