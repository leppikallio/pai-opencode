...
**Location:** `~/.config/opencode/skills/web-assessment/osint-tools/dnsrecon/`
...
**How to Run:**
```bash
cd ~/.config/opencode/skills/web-assessment/osint-tools/dnsrecon
...
**Location:** `~/.config/opencode/skills/web-assessment/osint-tools/whatweb/`
...
**How to Run:**
```bash
cd ~/.config/opencode/skills/web-assessment/osint-tools/whatweb
