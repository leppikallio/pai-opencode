...
export const CONFIG = {
  ...
  // Local paths
  paths: {
    root: '~/.config/opencode/skills/web-assessment/BugBountyTool',
    state: '~/.config/opencode/skills/web-assessment/BugBountyTool/state.json',
    cache: '~/.config/opencode/skills/web-assessment/BugBountyTool/cache',
    logs: '~/.config/opencode/skills/web-assessment/BugBountyTool/logs',
  },
