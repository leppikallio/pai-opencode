...
`~/.config/opencode/skills/CORE/USER/SKILLCUSTOMIZATIONS/red-team/`
...
- `message`: "Running the WORKFLOWNAME workflow from the red-team skill"
Running the **WorkflowName** workflow from the **red-team** skill...
```
