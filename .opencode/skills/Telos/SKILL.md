...
1. **Personal TELOS** - {principal.name}'s life context system (beliefs, goals, lessons, wisdom) at `~/.config/opencode/skills/PAI/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `~/.config/opencode/skills/PAI/USER/TELOS/` |
...
```
~/.config/opencode/skills/PAI/USER/TELOS/
```
...
All files located in `~/.config/opencode/skills/PAI/USER/TELOS/`:
...
```bash
# View specific file
read ~/.config/opencode/skills/PAI/USER/TELOS/GOALS.md
read ~/.config/opencode/skills/PAI/USER/TELOS/BELIEFS.md

# View recent updates
read ~/.config/opencode/skills/PAI/USER/TELOS/UPDATES.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `~/.config/opencode/skills/PAI/USER/TELOS/` (in PAI USER directory)
...
**Remember:** Personal TELOS files live at `~/.config/opencode/skills/PAI/USER/TELOS/` (in the PAI USER directory)
