...
1. **Personal TELOS** - {principal.name}'s life context system (beliefs, goals, lessons, wisdom) at `~/.config/opencode/skills/CORE/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `~/.config/opencode/skills/CORE/USER/TELOS/` |
...
All files located in `~/.config/opencode/skills/CORE/USER/TELOS/`:
...
```bash
# View specific file
read ~/.config/opencode/skills/CORE/USER/TELOS/GOALS.md
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `~/.config/opencode/skills/CORE/USER/TELOS/` (in CORE USER directory)
