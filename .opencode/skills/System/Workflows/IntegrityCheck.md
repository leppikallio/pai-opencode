...
You do NOT need to run all 12 agents every time.
...
```bash
bun ~/.config/opencode/skills/System/Tools/ScanBrokenRefs.ts --scope ~/.config/opencode/skills
```
