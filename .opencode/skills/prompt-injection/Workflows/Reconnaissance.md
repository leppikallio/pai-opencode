...
`~/.config/opencode/skills/prompt-injection/APPLICATION-RECONNAISSANCE-METHODOLOGY.md`

**Attack taxonomy for prioritization:**
`~/.config/opencode/skills/prompt-injection/COMPREHENSIVE-ATTACK-TAXONOMY.md`
