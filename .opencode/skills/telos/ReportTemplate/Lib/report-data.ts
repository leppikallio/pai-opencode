...
export const reportData: ReportData = {
  ...
  executiveSummary: {
    context: "This report presents findings from our comprehensive TELOS analysis of [RECIPIENT], conducted to assess strategic readiness and identify transformation opportunities.",
    methodology: {
  ...
  situationAssessment: {
    ...
    clientAsk: "Replace with what was originally requested",
