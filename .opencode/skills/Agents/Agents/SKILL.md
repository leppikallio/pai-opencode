...
```bash
# Usage examples
bun run ~/.opencode/skills/Agents/Tools/ComposeAgent.ts --task "Review security"
bun run ~/.opencode/skills/Agents/Tools/ComposeAgent.ts --traits "security,skeptical,thorough"
bun run ~/.opencode/skills/Agents/Tools/ComposeAgent.ts --list
bun run ~/.opencode/skills/Agents/Tools/ComposeAgent.ts --output json
```
