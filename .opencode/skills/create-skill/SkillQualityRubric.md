...
|---|---|---|---|
| Naming | Skill dir is kebab-case; `SKILL.md` is uppercase; root docs/Workflows/Tools follow project convention | Any naming mismatch | Look at paths + filenames |
...
| Title present | Body has a clear skill title heading (`# ...`) | Missing or wrong title | First heading in `SKILL.md` |
