...
Scope:
- Applies to create-skill’s import flow and the `ImportSkill` tool.
...
- Destination skill name: `<skill-name>` (kebab-case)
...
- Runtime path exists:
- `/Users/zuul/.config/opencode/skills/<skill-name>/SKILL.md`
...
1) Copy the full tree
   - Copy the entire source directory into `/Users/zuul/Projects/pai-opencode/.opencode/skills/<skill-name>/`.
