...
## Examples Location
`~/.config/opencode/skills/WebAssessment/WebappExamples/`
...
```bash
python ~/.config/opencode/skills/WebAssessment/WebappScripts/with_server.py \
    --server "npm run dev" \
    --port 5173 \
    -- python my_test.py
```
...
- Web app testing guide: `~/.config/opencode/skills/WebAssessment/Workflows/webapp/TestingGuide.md`
- Server helper script: `~/.config/opencode/skills/WebAssessment/WebappScripts/with_server.py`
