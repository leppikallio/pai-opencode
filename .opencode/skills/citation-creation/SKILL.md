...
`~/.config/opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/citation-creation/` (optional)
...
- `message`: "Running the WORKFLOWNAME workflow in the citation-creation skill"
