...
**Location:** `~/.config/opencode/skills/security/web-assessment/osint-tools/spiderfoot/`
...
**Basic scan:**
```bash
cd ~/.config/opencode/skills/security/web-assessment/osint-tools/spiderfoot
