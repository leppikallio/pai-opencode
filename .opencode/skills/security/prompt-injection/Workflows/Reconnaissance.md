...
- `message`: "Running the Reconnaissance workflow in the prompt-injection skill to map attack surface"
...
`~/.config/opencode/skills/security/prompt-injection/APPLICATION-RECONNAISSANCE-METHODOLOGY.md`
