...
Recommended invocation:
  ...
  uv run python <path-to-this-skill>/Tools/RunSecurityScan.py --mode all
"""
...
_DEFAULT_PAI_DIR = Path(
    os.environ.get("PAI_DIR") or (Path.home() / ".config" / "opencode")
).resolve()
DEFAULT_SKILLS_DIR = (_DEFAULT_PAI_DIR / "skills").resolve()
...
DEFAULT_ALLOWLIST_FILES = [
    (_SKILL_ROOT / "Data" / "allowlist.json").resolve(),
    (
        _DEFAULT_PAI_DIR
        / "skills"
        / "PAI"
