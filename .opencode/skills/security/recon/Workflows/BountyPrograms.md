...
bun ~/.config/opencode/skills/security/recon/Tools/BountyPrograms.ts list

# Show only paid bounty programs (not just swag)
bun ~/.config/opencode/skills/security/recon/Tools/BountyPrograms.ts list --bounty-only

# Search for programs by keyword
bun ~/.config/opencode/skills/security/recon/Tools/BountyPrograms.ts search "crypto"
bun ~/.config/opencode/skills/security/recon/Tools/BountyPrograms.ts search "finance"
bun ~/.config/opencode/skills/security/recon/Tools/BountyPrograms.ts search "cloud"

# Check if a domain has a bounty program
bun ~/.config/opencode/skills/security/recon/Tools/BountyPrograms.ts check example.com

# Update local cache from sources
bun ~/.config/opencode/skills/security/recon/Tools/BountyPrograms.ts update

# Export as JSON
bun ~/.config/opencode/skills/security/recon/Tools/BountyPrograms.ts list --json > bounty-programs.json
```
...
Local cache stored at: `~/.config/opencode/skills/security/recon/Data/BountyPrograms.json`
