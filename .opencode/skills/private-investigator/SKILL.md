...
`~/.config/opencode/skills/CORE/USER/SKILLCUSTOMIZATIONS/private-investigator/`
...
- `message`: "Running the WORKFLOWNAME workflow from the private-investigator skill"
Running the **WorkflowName** workflow from the **private-investigator** skill...
```
...
```
User: "Who called from [PHONE_NUMBER]?"
