...
SCAN_FILE=$PAI_DIR/MEMORY/WORK/${WORK_DIR}/scratch/$(date +%Y-%m-%d)_nmap-scan.txt

# Or masscan results
MASSCAN_FILE=$PAI_DIR/MEMORY/WORK/${WORK_DIR}/scratch/$(date +%Y-%m-%d)_masscan.json
...
// Usage: bun run tools/batch-scan-analysis.ts $PAI_DIR/MEMORY/WORK/{current_work}/scratch/target-scans/
```
