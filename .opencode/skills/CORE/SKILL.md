...
**Architecture:**
- **SYSTEM rules** (`~/.config/opencode/skills/CORE/SYSTEM/AISTEERINGRULES.md`): Universal rules. Always active. Cannot be overridden.
- **USER rules** (`~/.config/opencode/skills/CORE/USER/AISTEERINGRULES.md`): Personal customizations. Extend and can override SYSTEM rules for user-specific behaviors.
...
| Domain | Path | Purpose |
|--------|------|---------|
| **System Architecture** | `~/.config/opencode/skills/CORE/SYSTEM/PAISYSTEMARCHITECTURE.md` | Core PAI design and principles |
| **Memory System** | `~/.config/opencode/skills/CORE/SYSTEM/MEMORYSYSTEM.md` | WORK, STATE, LEARNING directories |
| **Skill System** | `~/.config/opencode/skills/CORE/SYSTEM/SkillSystem.md` | How skills work, structure, triggers |
| **Plugin System** | `~/.config/opencode/skills/CORE/SYSTEM/THEPLUGINSYSTEM.md` | OpenCode plugins, hooks mapping, implementation |
| **Agent System** | `~/.config/opencode/skills/CORE/SYSTEM/PAIAGENTSYSTEM.md` | Agent types, spawning, delegation |
| **Delegation** | `~/.config/opencode/skills/CORE/SYSTEM/THEDELEGATIONSYSTEM.md` | Background work, parallelization |
| **Browser Automation** | `~/.config/opencode/skills/CORE/SYSTEM/BROWSERAUTOMATION.md` | Playwright, screenshots, testing |
| **CLI Architecture** | `~/.config/opencode/skills/CORE/SYSTEM/CLIFIRSTARCHITECTURE.md` | Command-line first principles |
| **Notification System** | `~/.config/opencode/skills/CORE/SYSTEM/THENOTIFICATIONSYSTEM.md` | Voice, visual notifications |
| **Tools Reference** | `~/.config/opencode/skills/CORE/SYSTEM/TOOLS.md` | Core tools inventory |

**USER Context:** `~/.config/opencode/skills/CORE/USER/` contains personal data—identity, contacts, health, finances, projects. See `~/.config/opencode/skills/CORE/USER/README.md` for full index.

**Project Routing:**

| Trigger | Path | Purpose |
|---------|------|---------|
| "projects", "my projects", "project paths", "deploy" | `~/.config/opencode/skills/CORE/USER/TELOS/PROJECTS.md` | Technical project registry—paths, deployment, routing aliases |
| "Telos", "life goals", "goals", "challenges" | `~/.config/opencode/skills/CORE/USER/TELOS/TELOS.md` | Life goals, challenges, predictions (Telos Life System) |
