 ...
 *
 * Usage:
 *   bun ~/.config/opencode/skills/CORE/Tools/GetTranscript.ts <youtube-url>
 *   bun ~/.config/opencode/skills/CORE/Tools/GetTranscript.ts <youtube-url> --save <output-file>
 *
 * Examples:
 *   bun ~/.config/opencode/skills/CORE/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=abc123"
 *   bun ~/.config/opencode/skills/CORE/Tools/GetTranscript.ts "https://youtu.be/abc123" --save transcript.txt
 *
 * @author PAI System
 * @version 1.0.0
 */
