...
- `message`: "Running the TechnicalCreativityGemini3 workflow in the be-creative skill to generate technical solutions"
...
1. Load workflow: `read ~/.config/opencode/skills/thinking/be-creative/Workflows/TechnicalCreativityGemini3.md`
