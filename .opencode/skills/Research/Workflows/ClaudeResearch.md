 ...
 * ## Usage
 * ```bash
 * bun ~/.config/opencode/skills/research/Workflows/ClaudeResearch.md "your complex research question here"
 * ```
 *
 * ## Features
...
if (!originalQuestion) {
  ...
  console.error('Usage: bun ~/.config/opencode/skills/research/Workflows/ClaudeResearch.md "your question here"');
  process.exit(1);
}
