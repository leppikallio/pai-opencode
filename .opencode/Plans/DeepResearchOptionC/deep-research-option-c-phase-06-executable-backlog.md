...
## Dependencies
- Phase 05 synthesis/reviewer loop complete (produces `~/.config/opencode/research-runs/<run_id>/synthesis/final-synthesis.md` + validated citation pool).
...
- Phase 06 deliverables must make Gate E **mechanically computable** from an offline fixture bundle containing (at minimum):
  ...
  - `~/.config/opencode/research-runs/<run_id>/citations/citations.jsonl` (validated pool)
