...
### Erwartetes Ergebnis:
```bash
ls ~/.config/opencode/MEMORY/WORK/2026-01/
...
### Verifikation:
```bash
cat ~/.config/opencode/MEMORY/WORK/2026-01/*/META.yaml
...
### Erwartetes Ergebnis:
```bash
cat ~/.config/opencode/MEMORY/LEARNING/SIGNALS/ratings.jsonl
# Sollte JSON-Entry mit score: 8 zeigen
```

### Verifikation für niedrige Ratings (< 7):
```bash
ls ~/.config/opencode/MEMORY/LEARNING/RESPONSE/2026-01/
...
### Erwartetes Ergebnis:
```bash
ls ~/.config/opencode/MEMORY/RESEARCH/2026-01/
# Sollte zeigen: AGENT-{type}_{timestamp}_{slug}.md
```

### Verifikation:
```bash
cat ~/.config/opencode/MEMORY/RESEARCH/2026-01/AGENT-*.md | head -20
...
### Erwartetes Ergebnis:
```bash
ls ~/.config/opencode/MEMORY/LEARNING/*/2026-01/
...
```bash
# Erstelle manuell
mkdir -p ~/.config/opencode/MEMORY/{LEARNING/{ALGORITHM,CODE,GENERAL,RESPONSE,SIGNALS,SYSTEM},RESEARCH,STATE,WORK}
```
